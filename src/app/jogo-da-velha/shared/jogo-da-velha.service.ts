...
export class JogoDaVelhaService {
  ...
  /**
   * Retorna se a tela de ínicio deve ser exibido.
   * 
   * @return boolean
   */
  ...
  /**
   * Retorna o nómero do jogador a jogar.
   * 
   * @return number
   */
  get jogador(): number {
  ...
  /**
   * Lógica para simulta jogada do computador em modo aleatório.
   * 
   * @return void 
   */

  cpuJogar(): void {
    // verifica jogada da vitória
